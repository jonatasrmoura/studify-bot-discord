...
const exampleEmbed = new EmbedBuilder()
	...
	.setAuthor({ name: 'Fulano da Silva', iconURL: 'https://i.imgur.com/iG6wY99.png' })
	.setDescription('Descrição dos comandos do GIT')
	.setThumbnail('https://i.imgur.com/iG6wY99.png')
	.addFields(
